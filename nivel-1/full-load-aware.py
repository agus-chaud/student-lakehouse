...
# Default: localhost (terminal del Codespace / host).
# En un container de la misma red de compose, usar: "http://minio:9000"
...
# ---- Postgres
# Default: localhost (terminal del Codespace / host)
# En container de la misma red de compose, usar: postgres-container
